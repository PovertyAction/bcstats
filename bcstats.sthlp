...
{synopt:{opt showv:ar}}display error rates by variable{p_end}
{synopt:{opt showt:ype}}display error rates by variable type 
(types 1, 2, and 3). To show both rates by variable and type, this can be 
used in combination with {cmd:showvar}{p_end}
